...
def gmcp(input_video_path: str, output_video_path: str, tracklet_csv_path: str, detector: str, detector_cfg: dict):
    ...
    vcounter = 0
    step = detector_cfg[detector]["step"]
    smallstep = int(step / 5)

    del_files(dir_path=output_video_path)
    truncate_file(filename=tracklet_csv_path)

    for x in range(0, begin, step):
        vcounter = vcounter + 1
        begval = x
        step = smallstep
        hypdist = 80
        ...
        write_detections_summary(output_path=tracklet_csv_path,
        ...
        vidstring = f"ffmpeg -i tudout.mp4 {output_video_path}"
...
if __name__ == "__main__":
    ...
    gmcp(input_video_path=tracker_cfg["input_video"],
         output_video_path=tracker_cfg["output_video"],
         tracklet_csv_path=tracker_cfg["tracklet_detections"],
